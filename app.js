...
(function () {
          ...
          <div class="workspace-category-card">
            <div class="workspace-category-header">
              ...
              <div class="workspace-category-actions">
                ...
                <button class="secondary-btn" data-action="edit-category">Edit</button>
                <button class="secondary-btn" data-action="new-doc">New Doc</button>
              </div>
            </div>
  ...
  function openWorkspaceDocById(id) {
    ...
    docEditBtn.classList.remove('hidden');
  ...
  $('#workspace-add-btn').addEventListener('click', () => openCategoryEditor(null));
  $('#workspace-import-btn').addEventListener('click', () => {
    if (!ensureCategoryExistsBeforeDoc()) return;
    workspaceImportInput.click();
  });
  $('#workspace-header-new-btn').addEventListener('click', () => openEditorForDoc(null));
  $('#workspace-header-import-btn').addEventListener('click', () => {
    if (!ensureCategoryExistsBeforeDoc()) return;
    workspaceImportInput.click();
  });
  workspaceHeaderCategoryBtn.addEventListener('click', () => openCategoryEditor(null));
  workspaceExportBtn.addEventListener('click', downloadWorkspaceExport);
  workspaceEditBtn.addEventListener('click', editWorkspaceMeta);
  ...
  workspaceMetaSaveBtn.addEventListener('click', saveWorkspaceMeta);
